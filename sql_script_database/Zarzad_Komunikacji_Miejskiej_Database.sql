...
COMMENT ON COLUMN Producenci.Nr_producenta IS 'Unikalny numer producenta, klucz główny.';
...
update poczty set poczta = 'Krakow'
where Poczta = 'Krakow';
...
INSERT INTO Pracownicy (nr_pracownika, imie, nazwisko, miejscowosc, ulica, nr_budynku, nr_lokalu, nr_telefonu, data_urodzenia, data_zatrudnienia, nr_zarzadu, nr_poczty, nr_stanowiska) 
...
INSERT INTO Pracownicy (nr_pracownika, imie, nazwisko, miejscowosc, ulica, nr_budynku, nr_lokalu, nr_telefonu, data_urodzenia, data_zatrudnienia, nr_zarzadu, nr_poczty, nr_stanowiska) 
    Values(3, 'Krystyna', 'Krzeszowska', 'Krakow', 'Kaprysna', 52, 2, '113653512', '1985-06-25', '2014-02-17',1, 3, 3) ;
    
INSERT INTO Pracownicy (nr_pracownika, imie, nazwisko, miejscowosc, ulica, nr_budynku, nr_lokalu, nr_telefonu, data_urodzenia, data_zatrudnienia, nr_zarzadu, nr_poczty, nr_stanowiska) 
    Values(4, 'Asia', 'Malanowska', 'Warszawa', 'Blondw�osa', 325, 12, '643453512', '1993-06-25', '2018-12-21',1, 2, 3) ;
    
INSERT INTO Pracownicy (nr_pracownika, imie, nazwisko, miejscowosc, ulica, nr_budynku, nr_lokalu, nr_telefonu, data_urodzenia, data_zatrudnienia, nr_zarzadu, nr_poczty, nr_stanowiska) 
    Values(5, 'Wieslaw', 'Keras', 'Kielce', 'Osobliwa', 53, 93, '623457282', '1979-04-03', '2015-11-15',1, 1, 1) ;

INSERT INTO Stanowiska (Nr_stanowiska, nazwa_stanowiska, Opis) Values ('3', 'Ksiegowa', NULL);
INSERT INTO Stanowiska (Nr_stanowiska, nazwa_stanowiska, Opis) Values ('1', 'Kierowca', NULL);
